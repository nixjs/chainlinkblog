...
date: 2022-12-20
summary: 'Blockchain là một công nghệ cơ sở dữ liệu phân tán ở đó dữ liệu được lưu trữ ở các khối (blocks) nối tiếp nhau theo trình tự thời gian và không thay đổi được.'
---
